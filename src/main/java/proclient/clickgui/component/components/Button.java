...
public class Button extends Component {
	...
	public void renderComponent() {
		Gui.drawRect(parent.getX(), this.parent.getY() + this.offset, parent.getX() + parent.getWidth(), this.parent.getY() + 12 + this.offset, this.mod.isToggled() ? (this.isHovered ? 0xFF2d0a40 : 0xFF1a0626) : (this.isHovered ? 0xFF333333 : 0xFF1c1c1c));
