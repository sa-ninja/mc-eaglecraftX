...
public class ResentUtils {
    ...
    public static void drawRectOutline(double param1, double param2, double width1, double height1, int color) {
        Gui.drawRect((int)param1, (int)param2, (int)width1, (int)(param2 + 1), color);
        Gui.drawRect((int)param1, (int)param2, (int)(param1 + 1), (int)height1, color);
        Gui.drawRect((int)(width1 - 1), (int)param2, (int)width1, (int)height1, color);
        Gui.drawRect((int)param1, (int)(height1 - 1), (int)width1, (int)height1, color);
    }
