...
public class BlockUtils {
   ...
   public static boolean isOnLiquid() {
      ...
      AxisAlignedBB par1AxisAlignedBB = Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().offset(0.0D, -0.01D, 0.0D).contract(0.001D, 0.001D, 0.001D);
   ...
   public static boolean isInLiquid() {
      Minecraft.getMinecraft();
      AxisAlignedBB par1AxisAlignedBB = Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().contract(0.001D, 0.001D, 0.001D);
      int var4 = MathHelper.floor_double(par1AxisAlignedBB.minX);
      int var5 = MathHelper.floor_double(par1AxisAlignedBB.maxX + 1.0D);
      int var6 = MathHelper.floor_double(par1AxisAlignedBB.minY);
      int var7 = MathHelper.floor_double(par1AxisAlignedBB.maxY + 1.0D);
   ...
   public static boolean CanStep() {
      Minecraft.getMinecraft();
      AxisAlignedBB par1AxisAlignedBB = Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().contract(0.0D, 0.001D, 0.0D);
      int var6 = MathHelper.floor_double(par1AxisAlignedBB.minY);
      int var7 = MathHelper.floor_double(par1AxisAlignedBB.maxY + 1.0D);
   ...
   public static boolean isInsideBlock() {
      ...
      while(true) {
         Minecraft.getMinecraft();
         if (x >= MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().maxX) + 1) {
            return false;
         }

         Minecraft.getMinecraft();
         int y = MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().minY);

         while(true) {
            Minecraft.getMinecraft();
            if (y >= MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().maxY) + 1) {
               ++x;
               break;
            }
            ...
            while(true) {
               Minecraft.getMinecraft();
               if (z >= MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().maxZ) + 1) {
                  ++y;
                  break;
               }
               ...
               if (block != null && !(block instanceof BlockAir)) {
                  ...
                  if ((boundingBox = block.getCollisionBoundingBox(var10001, var10002, Minecraft.getMinecraft().theWorld.getBlockState(new BlockPos(x, y, z)))) != null) {
                     Minecraft.getMinecraft();
                     if (Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().intersectsWith(boundingBox)) {
                        return true;
                     }
                  }
               }
