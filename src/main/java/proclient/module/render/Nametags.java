    ...
    public void onEvent(Event e) {
        ...
        if (e instanceof EventRenderWorld) {
            ...
            for (EntityPlayer entity : mc.theWorld.playerEntities) {
                ...
                Gui.drawRect((int)(-namewidth / 2 - 2), 42, (int)(namewidth / 2 + 2), 40, 0x90080808);
                    Gui.drawRect((int)(-namewidth / 2 - 15), 42, (int)(namewidth / 2 + 15 - (1 - (entity.getHealth() / entity.getMaxHealth())) * (namewidth + 4)), 40, colorrectCode);
                    Gui.drawRect((int)(-namewidth / 2 - 15), 20, (int)(namewidth / 2 + 15), 40, 0x90202020);
